...
(0, node_test_1.describe)('Traverse: completion barrier performance', () => {
    ...
    (0, node_test_1.test)('completion performs no per-task table scans (constant, not linear)', async () => {
        ...
        (0, code_1.expect)(large).equal(small);
    });
});
